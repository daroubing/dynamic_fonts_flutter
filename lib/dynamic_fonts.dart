...
class DynamicFonts {
  ...
  static TextThemeBuilder themeBuilder(TextStyleBuilder styleBuilder) =>
      ([textTheme]) {
        ...
        return TextTheme(
          display4: styleBuilder(textStyle: textTheme?.display4),
          display3: styleBuilder(textStyle: textTheme?.display3),
          display2: styleBuilder(textStyle: textTheme?.display2),
          display1: styleBuilder(textStyle: textTheme?.display1),
          headline: styleBuilder(textStyle: textTheme?.headline),
          title: styleBuilder(textStyle: textTheme?.title),
          subhead: styleBuilder(textStyle: textTheme?.subhead),
          subtitle: styleBuilder(textStyle: textTheme?.subtitle),
          body2: styleBuilder(textStyle: textTheme?.body2),
          body1: styleBuilder(textStyle: textTheme?.body1),
